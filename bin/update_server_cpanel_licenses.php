            ...
            while ($db->next_record(MYSQL_ASSOC)) {
                ...
                if ($db2->num_rows() > 0) {
                    ...
                    if ($ips[$ip]['server_cost'] != $db->Record['repeat_invoices_cost']) {
                        ...
                        //$db2->query("update repeat_invoices set repeat_invoices_cost='{$ips[$ip]['server_cost']}' where repeat_invoices_id={$db->Record['repeat_invoices_id']}");
                    }
                } else {
                    ...
                    if ($go == true) {
                        ...
                        $db2->query("update repeat_invoices set repeat_invoices_cost={$new_cost} where repeat_invoices_id={$db->Record['repeat_invoices_id']}");
                    }
