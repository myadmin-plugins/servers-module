...
The class under contract here is `Detain\MyAdminServers\Plugin`.
...
- This package declares `$module = 'servers'`. Changing it detaches the plugin from the events core dispatches to it, so the generated pin asserts it.
